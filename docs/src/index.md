...
| `DoubleMLPLRConformal`, `DoubleMLPLRConformalUT` | Conformal uncertainty quantification (research) | `ml_l`, `ml_m` (conformal-wrapped)    | 🔬 Experimental, research prototype |
...
- [User Guide](user-guide.md) - Installation, concepts, and workflow
- [Tutorials](tutorials/plr.md) - Step-by-step examples
- [API Reference](api.md) - Complete API documentation
- [Examples](examples.md) - Pluto notebooks
